...
public class Textp extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public Textp(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public Textp(String text, JTextComponent component, Show show) {
